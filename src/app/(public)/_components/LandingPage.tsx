         ...
         <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-slate-950/80 backdrop-blur-xl border-b border-white/5 py-0 shadow-2xl shadow-indigo-500/5' : 'bg-transparent border-transparent py-4'}`}>
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between relative">
               ...
               <div className="hidden md:flex items-center justify-center gap-10">
                  ...
                  <a href="/demo-tour" className="text-sm font-bold text-slate-300 hover:text-white transition-colors flex items-center gap-1.5 group">
               ...
               {isMobileMenuOpen && (
                  ...
                  >
                     <div className="flex flex-col gap-4">
                        ...
                        <a href="/demo-tour" className="text-lg font-bold text-slate-300" onClick={() => setIsMobileMenuOpen(false)}>Lihat Demo</a>
                     </div>
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
               ...
               <div className="flex gap-16">
                  <div className="flex flex-col gap-4">
                     ...
                     <a href="/demo-tour" className="text-xs font-bold hover:text-indigo-400 transition-colors">Live Demo</a>
                  </div>
                  <div className="flex flex-col gap-4">

...
import { useNavigate, useLoaderData } from '@koda/runtime';
import { ArrowLeft, Loader2 } from 'lucide-react';
import { BlogPost } from '@/lib/blog';

export const BlogIndex = () => {
    const navigate = useNavigate();
    const { posts: allPosts } = useLoaderData() as { posts: BlogPost[] };
    ...
    // Higher level Suspense in PublicShell handles initial loading
    // Page level logic continues below
        ...
        <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30">
            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 pt-32 md:pt-40 pb-20">
                ...
                {selectedCategory === 'All' && !searchQuery && featuredPost && (
                    <div className="hidden md:block mb-16 group cursor-pointer" onClick={() => navigate(`/blog/${featuredPost.slug}` as any)}>

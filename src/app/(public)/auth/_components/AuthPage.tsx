...
export const AuthPage: React.FC<AuthPageProps> = ({
    ...
    return (
        <div className="min-h-screen w-full bg-white text-slate-900 flex flex-col lg:flex-row font-sans">
            ...
            <div className="w-full lg:w-1/2 flex flex-col min-h-screen relative bg-white">
                {/* Header */}

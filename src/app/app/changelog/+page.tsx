...
/**
 * 🏔️ Zenith Changelog (+page)
 * Maps to /app/changelog
 */
export const ChangelogPage: React.FC = () => {
  ...
  return (
    <div className="animate-in slide-in-from-right duration-500 pb-20">
      <BentoCard className="p-8 lg:p-10">
        ...
        <div className="space-y-12 relative z-10">
          {versions.map((ver, idx) => (
            <div key={idx} className="relative pl-10 lg:pl-12 group">
              ...
              <BentoCard
                className={`transition-all hover:shadow-md ${idx === 0 ? 'bg-indigo-50/30 border-indigo-100' : 'bg-slate-50/50 border-slate-100'}`}
                noPadding
              >
                <div className="p-6">

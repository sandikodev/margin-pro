...
/**
 * 🏔️ Zenith Onboarding (+page)
 * Self-contained wizard for first business creation.
 */
export const OnboardingPage: React.FC = () => {
   const { createBusiness } = useProfile();
   ...
   const handleComplete = async (profileData: Partial<BusinessProfile>) => {
      setLoading(true);
      try {
         const newBiz: BusinessProfile = {
            id: crypto.randomUUID(),
            name: profileData.name || 'Bisnis Baru',
            type: profileData.type || 'fnb_offline',
            targetMargin: profileData.targetMargin || 30,
            taxRate: profileData.taxRate || 0,
            initialCapital: profileData.initialCapital || 0,
            monthlyFixedCost: profileData.monthlyFixedCost || 0,
            currency: 'IDR',

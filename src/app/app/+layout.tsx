...
import { Navigate, useLocation, Outlet, useLoaderData } from '@koda/runtime';
...
export const Layout = () => {
    ...
    const loaderData = useLoaderData() as { businesses: BusinessProfile[] };
    const profile = useProfile(loaderData?.businesses);

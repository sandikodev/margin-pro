...
import { CREDIT_PACKAGES } from '@/shared/constants/pricing';
...
const PACKAGES = [
    {
        ...
        price: CREDIT_PACKAGES.SMALL.price,
    ...
    },
    {
        ...
        price: CREDIT_PACKAGES.MEDIUM.price,
    ...
    },
    {
        ...
        price: CREDIT_PACKAGES.LARGE.price,
...
export default function TopUpPage() {
    ...
    const { topUpCredits, credits: currentCredits } = useMarketplace();
    const { formatValue } = useCurrency();
    const navigate = useNavigate();

    const onBack = () => setActiveTab('profile'); // Or navigate('/app/profile') ? setActiveTab is safer for tab state sync
    const onHistoryClick = () => setActiveTab('profile');

...
import { useMidtrans } from '@/core/hooks/useMidtrans';
...
import { cn } from '@/shared/utils/business-logic';
...
import { PRICING_OPTIONS, PRICING_TIERS } from '@/shared/constants/pricing';
...
export default function PricingPage() {
    ...
    const handleAction = async (tier: 'starter' | 'pro_monthly' | 'pro_lifetime') => {
        ...
        setIsLoading(true);
        try {
            const selectedTier = tier === 'pro_monthly' ? PRICING_TIERS.PRO_MONTHLY : PRICING_TIERS.PRO_LIFETIME;

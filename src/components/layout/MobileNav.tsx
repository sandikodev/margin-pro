...
import { Home, PieChart, GraduationCap, Banknote, FlaskConical } from 'lucide-react';

export type TabId = 'home' | 'cashflow' | 'insights' | 'edu' | 'market' | 'profile' | 'topup' | 'calc' | 'about' | 'changelog' | 'lab';

...
import { Sparkle, Plus, ShoppingBag } from 'lucide-react';
...
export const HeroWidget: React.FC<HeroWidgetProps> = ({ createNewProject, setActiveTab, className }) => {
  ...
  return (
    <BentoCard noPadding className={`bg-slate-950 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] border-white/5 p-7 group ${className}`}>

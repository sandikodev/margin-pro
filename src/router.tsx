...
import { PricingPage } from './_legacy/routes/public/pricing';
import { InvitePage } from './_legacy/routes/public/invite';
import { BlogIndex } from './_legacy/routes/public/blog';
import { BlogPostPage } from './_legacy/routes/public/blog/post';
import { LegalIndexPage } from './_legacy/routes/public/legal/index';
import { LegalDocumentPage } from './_legacy/routes/public/legal/document';
import { PublicErrorTestPage, PublicErrorTestTrigger } from './_legacy/routes/public/PublicErrorTest';
...
} from './_legacy/router-components';

const AdminDashboard = React.lazy(() => import('./_legacy/routes/system/admin').then(module => ({ default: module.AdminDashboard })));
const AcademyView = React.lazy(() => import('./_legacy/routes/app/academy').then(module => ({ default: module.AcademyView })));
const AboutView = React.lazy(() => import('./_legacy/routes/app/about').then(module => ({ default: module.AboutView })));
const ChangelogView = React.lazy(() => import('./_legacy/routes/app/changelog').then(module => ({ default: module.ChangelogView })));
const AppErrorTestPage = React.lazy(() => import('./_legacy/routes/app/AppErrorTest').then(module => ({ default: module.AppErrorTestPage })));
const AppErrorTestTrigger = React.lazy(() => import('./_legacy/routes/app/AppErrorTest').then(module => ({ default: module.AppErrorTestTrigger })));
const AppDXTestPage = React.lazy(() => import('./_legacy/routes/app/AppDXTest').then(module => ({ default: module.AppDXTestPage })));

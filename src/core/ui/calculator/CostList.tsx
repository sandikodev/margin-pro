...
import { PlusCircle, Trash2, Loader2, Package, Sparkles, CheckCircle2, ArrowRightLeft, Scale, Layers, Ruler, Plus, Info, CalendarClock, PieChart as PieChartIcon, Hammer, Box } from 'lucide-react';
import { PieChart, Pie, Cell, ResponsiveContainer, Tooltip, Legend } from 'recharts';
import { Project, ProductionConfig, CostItem } from '@shared/types';
import { calculateEffectiveCost, calculateOperationalBurnRate } from '@/shared/utils/business-logic';
import { useAIEstimator } from '@/core/hooks/useAIEstimator';
